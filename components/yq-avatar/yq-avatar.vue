    ...
    export default {
        ...
        methods: {
            fWindowResize() {
                ...
                this.expWidth && (this.eW = this.expWidth.toString().indexOf('upx') >= 0 ? parseInt(this.expWidth) *
                    this.pxRatio :
                            ...
                            success: r => {
                                ...
                                if (!this.hasSel) {
                                    ...
                                    if (this.selWidth && this.selHeight) {
                                        const sW = this.selWidth.toString().indexOf('upx') >= 0 ?
            ...
            fChooseImg(index = undefined, params = undefined, data = undefined) {
                if (params) {
                    ...
                    expWidth && (this.eW = expWidth.toString().indexOf('upx') >= 0 ? parseInt(expWidth) * this.pxRatio :
                        parseInt(
                            expWidth));
                    expHeight && (this.eH = expHeight.toString().indexOf('upx') >= 0 ? parseInt(expHeight) * this
                        .pxRatio : parseInt(
                            expHeight));
                    this.letRotate = (canRotate === false || inner === true || inner === 'true' || canRotate ===
                        'false') ? 0 : 1;
