    ...
    <view class="content" :style="{width: winWidth + 'px',height: winHeight + 'px'}">
        <view class="contentInside">
            <view class="itemsView">
                <view class="itemsTitleTextView">全称<span class="requiredItemSpan uni-ml-3">*</span></view>
                <view class="itemsRightShowContentView">
                    <view>
                        <uni-easyinput v-model="name" placeholder="请输入全称" maxlength="80"></uni-easyinput>
                    </view>
                    <view class="itemsRemarkView">主体名称需严格按照证件填写，在注册确认后不可更改。</view>
                </view>
            </view>
            <view class="itemsView uni-mt-5">
                <view class="itemsTitleTextView">身份证明<span class="requiredItemSpan uni-ml-3">*</span></view>
                <view class="itemsRightShowContentView">
                    <view>
                    ...
                    <view class="itemsRemarkView">
                        请上传能证明身份信息，<br />格式要求:原件照片、扫描件或者加盖公章的复印件，支持.jpg.png格式照片，大小不超过10M.</view>
                </view>
            </view>
            <!-- <view class="itemsView uni-mt-5">
